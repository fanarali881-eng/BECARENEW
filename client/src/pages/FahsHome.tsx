...
export default function FahsHome() {
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden" dir="rtl" style={{ fontFamily: "'Tajawal', sans-serif" }}>
      ...
      {/* Floating Contact Button - Single button: circle → capsule on hover */}
      <div className="fixed bottom-20 left-4 z-50">
        <button className="h-14 rounded-full shadow-lg flex items-center justify-center text-white overflow-hidden transition-all duration-500 ease-in-out w-14 hover:w-40 hover:gap-3 hover:px-5 group" style={{ backgroundColor: '#f5a623' }}>
          ...
          <span className="text-white font-bold text-sm whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-500">راسلنا</span>
        </button>
      </div>
