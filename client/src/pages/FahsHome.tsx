          ...
          {activeTab !== 'vehicles' ? (
            <div className="bg-white px-4 md:px-10 lg:px-14 pt-8 pb-12 md:pb-16 flex items-center justify-center">
              <div className="text-center">
                ...
                <div className="inline-flex items-center gap-2 px-6 py-3 rounded-lg" style={{ backgroundColor: '#e8f0f8', border: '3px solid #f5a623', animation: 'blinkMsg 2s ease-in-out infinite' }}>
